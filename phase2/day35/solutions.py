"""
Day 35: Statistics — Descriptive Statistics — Solutions
"""
...
def percentile_ranks(data):
    ...
    *data* that are less than or equal to *v*.  Use
    ...
    """
    return [
        stats.percentileofscore(data, v, kind="rank")
        for v in data
    ]
...
def frequency_table(data):
    ...
    df = pd.DataFrame({
        ...
        "relative_freq": (freq.values / freq.values.sum()).round(4),
